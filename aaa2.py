...
pred = pd.DataFrame(np.column_stack(
    [parkinson_list, localJitter_list, localabsoluteJitter_list, rapJitter_list, ppq5Jitter_list, localShimmer_list,
     localdbShimmer_list, apq3Shimmer_list, aqpq5Shimmer_list, apq11Shimmer_list, hnr05_list, hnr15_list, hnr25_list]),
                    columns=["Parkinson", "Jitter_rel", "Jitter_abs", "Jitter_RAP", "Jitter_PPQ", "Shim_loc", "Shim_dB",
...
predictors = ["Jitter_rel", "Jitter_abs", "Jitter_RAP", "Jitter_PPQ", "Shim_loc", "Shim_dB", "Shim_APQ3", "Shim_APQ5",
              "Shi_APQ11", "hnr05", "hnr15", "hnr25"]  # Listing predictors
...
from sklearn.model_selection import train_test_split # divide train and test dataset

X_train, X_test, y_train, y_test = train_test_split(parkinson[predictors], parkinson['Parkinson'], test_size=0.25,
                                                    random_state=1)
